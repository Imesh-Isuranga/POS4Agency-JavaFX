...
public class MainItem {
    ...
    public MainItem(String code, int boxQty, int itemQty) {
        this.code = code;
        this.boxQty = boxQty;
        this.itemQty = itemQty;
    }

    public MainItem(String code, String name, double unitPrice_Box_Agency, double unitPrice_Box, int itemCountInBox, int boxQty, int itemQty) {
        this.code = code;
        this.name = name;
